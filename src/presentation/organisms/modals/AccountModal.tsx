...
export default function AccountModal({ profile }: AppModalProps) {
  ...
  return (
    <Pressable style={styles.modalContainer}>
      ...
      <ThemedText numberOfLines={4} style={{...styles.addressText, color}}>
        ...
        <ThemedIcon size={14} name='copy' type='Feather' style={{paddingLeft: 10}} />
      </ThemedText>
      ...
      <ThemedView style={{...styles.networkView}}>
        ...
        <ThemedText style={{...styles.networkText, color, left: 3}} onPress={()=>setShowFulladdress(true)}>Show full address</ThemedText>
      </ThemedView>
    </Pressable>
  );
}
